...
<template>
  <div style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: #f9fafb;">
    <div style="background: #fff; padding: 40px; border-radius: 16px; border: 1px solid #e5e7eb; width: 100%; max-width: 380px;">
      <h1 style="font-size: 22px; font-weight: 700; margin: 0 0 28px; text-align: center;">
        Admin
      </h1>
      ...
      <p v-if="errorKey" style="color: #ef4444; font-size: 13px; margin: -12px 0 16px;">
        {{ t(errorKey) }}
      </p>
      <button
      ...
      <p style="text-align: center; margin-top: 20px;">
        <RouterLink to="/" style="font-size: 13px; color: #6b7280;">
          {{ t('auth.backToSite') }}
        </RouterLink>
      </p>
    </div>
